...
- **V03 article_text_hash**: warn - WARN: framework CONST self-reported SHA in metadata header (26b530c1…) does not match actual content SHA (a42140a7…). | WARN: framework AN9 self-reported SHA in metadata header (3cedf261…) does not match actual content SHA (57c4f76b…).
