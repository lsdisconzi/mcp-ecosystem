...
- **V03 article_text_hash**: warn - WARN: framework CPB self-reported SHA in metadata header (0b2ccdca…) does not match actual content SHA (fda5a60d…). | WARN: framework CONST self-reported SHA in metadata header (de946205…) does not match actual content SHA (b0b99bed…).
