...
- **V03 article_text_hash**: warn - WARN: framework AN17 self-reported SHA in metadata header (be310dca…) does not match actual content SHA (81e5ac9c…).
