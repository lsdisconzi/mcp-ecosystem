...
- **V17 cross_view_consistency**: pass - Bundle and contract agree on 0 open question(s) and 25 cross-reference(s) (25 item(s) compared). Contract-only related_violations: 8 (not asserted against cross_references; reciprocity is a graph-level audit).
