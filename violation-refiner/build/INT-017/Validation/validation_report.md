...
- **V03 article_text_hash**: warn - WARN: framework VCCR self-reported SHA in metadata header (4e9bc346…) does not match actual content SHA (5e7196e8…).
