...
- **V01 segment_resolution**: pass - 183 segment(s) checked; 0 unresolved.
- **V02 verbatim_quote_match**: pass - All 183 quote(s) checked against their cited segment.
- **V03 article_text_hash**: warn - WARN: framework ACHR self-reported SHA in metadata header (5e4270a2…) does not match actual content SHA (0208ba5c…).
