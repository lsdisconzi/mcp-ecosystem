...
- **V06 element_coverage**: warn - 2 uncovered: ['CL.CACH.Art.133.1.elem.obligacion_eleccion_pasajero: status=strong but no nexus_matrix entry', 'CL.CACH.Art.133.2.elem.obligacion_compensacion: status=strong but no nexus_matrix entry']
