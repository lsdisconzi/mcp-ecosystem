...
- **V01 segment_resolution**: pass - 2 segment(s) checked; 0 unresolved.
- **V02 verbatim_quote_match**: pass - All 2 quote(s) checked against their cited segment.
...
- **V05 cross_references_resolve**: pass - All 33 cross-references resolve.
- **V06 element_coverage**: warn - 1 uncovered: ['CL.CACH.Art.133.1.elem.sujeto_pasivo_pasajero: status=strong but no nexus_matrix entry']
