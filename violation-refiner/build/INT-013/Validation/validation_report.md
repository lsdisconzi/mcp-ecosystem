...
- **V03 article_text_hash**: warn - WARN: framework MC99 self-reported SHA in metadata header (778a8918…) does not match actual content SHA (bc79e373…). | WARN: framework UNGCP self-reported SHA in metadata header (4ef0d058…) does not match actual content SHA (a2a9861c…).
