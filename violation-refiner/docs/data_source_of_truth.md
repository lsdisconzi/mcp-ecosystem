...
| `violationrefiner_*` | **violation-refiner** | per embedder | `_segments`, `_articles`, `_authorities`, `_jurisprudence` | Yes (own namespace) |
...
`QDRANT_COLLECTION_PREFIX` namespace (default `violationrefiner`).
